...
export default class InsertMatchRow extends React.Component<any, any> {
  constructor(props) {
    super(props);
    ...
    return (
      <tr key={this.state.match.id}>
        ...
        <td>
          ...
          /> <input type="checkbox" value={String(hasPenalties)} data-id="has-penalties" checked={hasPenalties}
